...
class Url
{
    ...
    /**
     * Get Item - necessary for added by
     *
     * @param string $itemKey
     * @param array $params
     * @return string
     */
    public function item($itemKey,$params)
    {
        return sprintf('%s/%s/%s/items/%s', self::BASE,
            $this->type, $this->id, $itemKey, $this->getParams($params));
    }
